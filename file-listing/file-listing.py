...
rdm_list_files_url = "{0}/rdm/v1/site/{1}/domain/{2}/view/{3}".format(server_url, args.siteid, "file_system", "v_fs_files_by_folder")
...
print ("Files listing result for site {0} \n{1}".format(args.siteid, json.dumps(response.json(), indent=4)))
